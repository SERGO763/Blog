...
def check_topic_owner(request, topic):
    """Проверяет, что пользователь, связанный с темой, является текущем пользователем"""
...
def new_topic(request):
    ...
    # Вывести пустую или нействительную форму
    context = {'form' : form}
...
def edit_entry(request, entry_id):
    ...
    if request.method != 'POST':
        # Исходный запрос; форма заполнется данными текущей записи.
